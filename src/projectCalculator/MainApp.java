...
public class MainApp {
	public static void main(String[] args) {
		...
		System.out.println(res);   //NOTE: THIS OUTPUT IS BASED ON LEFT TO RIGHT ASSOCIATIVITY OF EXPRESSION
		                          //THIS APPLICATION IS JUST FOR PRACTICING USE OF CLASSES TO CREATE APPLICATION 
	}
}
